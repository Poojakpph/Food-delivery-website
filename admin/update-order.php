       ...
       <form action="" method="POST">
        ...
        <?php
            if(isset($_POST['submit'])){
                //get all the values from form and update the values and redirect to manage order page
                $id=$_POST['id'];
                $price=$_POST['price'];
                $qty=$_POST['qty'];
                $total= $price * $qty;
                ...
                if($res2==true){
                    $_SESSION['update']= "<div class='text-center'> Order Updated Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-order.php');
                   }
                else{
                    $_SESSION['update']= "<div class='text-center'> Failed to Update Order.</div>";
                    header('location:'.SITEURL.'admin/manage-order.php');
                }
            }
        ?>
