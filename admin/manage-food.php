                  ...
                  while($row=mysqli_fetch_assoc($res)){
                     ...
                     ?>
                       <tr>
                           ...
                           <td>
                              <?php 
                               //check whter we've img or not
                                if($img_name==""){
                                 //we don't ve img so display error message
                           ...
                           <td>
                              ...
                              <a href="<?php echo SITEURL; ?>admin/delete-food.php?id=<?php echo $id; ?>&img_name=<?php echo $img_name; ?>"
